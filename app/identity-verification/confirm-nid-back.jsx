        ...
        <View style={styles.container}>
            ...
            <View style={styles.checklistSection}>
                <H6 style={styles.checklistTitle}>
                    {t("confirmNidBack.detectedTitle")}
                </H6>

                <View style={styles.checklistItem}>
                    <PrimaryTickMarkIcon />
                    <Body2 style={styles.checkText}>
                        {t("confirmNidBack.checks.readable")}
                    </Body2>
                </View>
                ...
                <View style={styles.checklistItem}>
                    <PrimaryTickMarkIcon />
                    <Body2 style={styles.checkText}>
                        {t("confirmNidBack.checks.occupies")}
                    </Body2>
                </View>

                <H6 style={styles.confirmTitle}>
                    {t("confirmNidBack.confirmTitle")}
                </H6>

                <View style={styles.checklistItem}>
                    <Text style={styles.bulletPoint}>•</Text>
                    <Body2 style={styles.checkText}>
                        {t("confirmNidBack.checks.notExpired")}
                    </Body2>
                </View>
            </View>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.confirmButton} onPress={handleConfirm}>
                    <H6 style={styles.confirmButtonText}>
                        {t("confirmNidBack.confirm")}
                    </H6>
                </TouchableOpacity>

                <TouchableOpacity style={styles.retakeButton} onPress={handleRetake}>
                    <Body2 style={styles.retakeButtonText}>
                        {t("confirmNidBack.retake")}
                    </Body2>
                </TouchableOpacity>
            </View>
        </View>
