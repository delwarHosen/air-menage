        ...
        <View style={styles.calendarOverlay}>
          <View style={styles.calendarModal}>
            <View style={styles.dateContainer}>
              <Body2>{t('datepicker.select_date')}</Body2>
              <H1 style={styles.dateHeading}>{selectedDate ? formatDate(selectedDate) : t('datepicker.select_date')}</H1>
            </View>
            ...
            <View style={styles.monthNavigation}>
              ...
              <TouchableOpacity onPress={() => setCurrentMonth(new Date(currentMonth.getFullYear(), currentMonth.getMonth() + 1, 1))}>
                <Body2 style={styles.navArrow}>›</Body2>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.calendarGrid}>
              {getDaysInMonth(currentMonth).map((d, i) => (
                <TouchableOpacity
                  key={i}
                  style={[styles.dayCell, !d && styles.emptyDayCell, d && isSameDay(d, selectedDate) && styles.selectedDayCell]}
                  onPress={() => d && onSelectDate(d)}
                  disabled={!d}
                >
